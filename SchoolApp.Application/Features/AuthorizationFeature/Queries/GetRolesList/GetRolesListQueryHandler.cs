using SchoolApp.Application.Features.AuthorizationFeature.Queries.GetRolesList;

namespace SchoolApp.Application.Features.AuthorizationFeature.Queries.GetRolesList;
